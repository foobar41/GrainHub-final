...
const Privacy = () => {
    ...
    <div class="privacy-page-body">
        <div class="privacy-content">
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">GrainHub is committed to protecting your privacy and developing technology that gives you the most powerful and safe online experience. This Statement of Privacy applies to the GrainHub website and governs data collection and usage. By
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text-followed">One of the primary purposes of cookies is to provide a convenience feature to save you time. The purpose of a cookie is to tell the Web server that you have returned to a specific page. For example, if you personalize GrainHub pages, or
                ...
                you return to the same GrainHub Web site, the information you previously provided can be retrieved, so you can easily use the features that you customized.</div>
            <div class="privacy-paragraph-body privacy-paragraph-text">You have the ability to accept or decline cookies. Most Web browsers automatically accept cookies, but you can usually modify your browser settings to decline cookies if you prefer. If you choose to decline cookies, you may not be able to
                fully experience the interactive features of the GrainHub website or any web sites you visit.
            </div>
            <div class="privacy-paragraph-heading">Security of your Personal Information</div>
            <div class="privacy-paragraph-body privacy-paragraph-text">GrainHub secures your personal information from unauthorized access, use or disclosure. We also secure the personally identifiable information you provide on computer servers in a controlled, secure environment, protected from unauthorized
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">We will occasionally update this Statement of Privacy to reflect company and customer feedback. We also encourage you to periodically review this Statement to be informed of how GrainHub is protecting your information.
            </div>
            {/*  <div class="privacy-paragraph-heading">Contact Information</div>
            <div class="privacy-paragraph-body privacy-paragraph-text">
                <p>GrainHub welcomes your comments regarding this statement of Privacy. If you believe that GrainHub has not adhered to this statement, please contact us at <a style="text-decoration: none;" href="mailto:bookspace30@gmail.com">bookspace30@gmail.com</a>                    or bookspace.com. We will use commercially reasonable efforts to promptly determine and remedy the problem.</p>
            </div> */ }
        </div>
