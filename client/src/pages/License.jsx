...
const License = () => {
    return (
        ...
        <body>
        <div class="privacy-page-top">GrainHub</div>
        ...
        <div class="privacy-content">
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">“Licensor” means any person or entity that distributes its Work.“Software” means the original work of authorship made available under this License.“Work” means the Software and any additions to Software that are made available under
                this License. "This Agreement" refers to this license agreement, and terms and conditions specified herein.“Web Template” refers to GrainHub project, website template, theme, skin, or any copyrightable work licensed under this
                Agreement."GrainHub" refers to the website www.bookspace.com, its owner, and its successors, or manufacturer of this Template.
            </div>
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text-followed">After reading this agreement carefully, if you (Licensee) do not agree to all of the terms of this agreement, you may not download or use this Web Template. Your download or use of this Web Template indicates your acceptance of This Agreement.
                All updates to the Web Template provided by GrainHub shall be considered part of the Web Template and subject to the terms of this Agreement. </div>
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text-followed"> The Web Template is copyrighted and protected by the laws of the India and other countries, and international treaty provisions. GrainHub may make changes to the Web Template at any time without notice, but is not obligated to support or
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">Except as otherwise expressly provided, GrainHub grants no express or implied right under its patents, copyrights, trademarks, or other intellectual property rights.</div>
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">THE WEBSITE IS PROVIDED "AS IS" AND GRAINHUB DISCLAIMS ALL WARRANTIES RELATING TO THIS WEB TEMPLATE, WHETHER EXPRESSED OR IMPLIED, INCLUDING BUT NOT LIMITED TO ANY IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE.
            </div>
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text-followed">You agree that monetary damages alone is not an adequate and just relief resulting from any breach of this Agreement, that a court order prohibiting any further breach of this Agreement may be issued to prevent further damages, and that you
                will not oppose any reasonable request for a temporary restraining order, preliminary injunction, or other relief sought by GrainHub in the event of a breach of this Agreement.</div>
            ...
            <div class="privacy-paragraph-body privacy-paragraph-text">This Agreement contains the entire agreement between you and GrainHub and supersedes any previous understanding, commitments or agreements, oral or written. Further, this Agreement may not be modified, changed, or otherwise altered in any
